...
:repository-commit-presentation-hash: de19b8059c410dc49e036d681749c7f8db8d609a
...
:repository-commit-presentation-link: {repository}/commit/{repository-commit-presentation-hash}
...
{repository-commit-presentation-link}[`{repository-commit-presentation-hash}`]
